...
<!-- jvectormap -->
<script src="<?php echo base_url('assets/template/back/plugin') ?>/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="<?php echo base_url('assets/template/back/plugin') ?>/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<!-- jQuery Knob Chart -->
...
<!-- Bootstrap WYSIHTML5 -->
<script src="<?php echo base_url('assets/template/back/plugin') ?>/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
<!-- Slimscroll -->
...
<script src="<?php echo base_url('assets/template/back/dist') ?>/js/<?php echo base_url('assets/template/back/pages') ?>/dashboard.js"></script>
